...
CREATE TABLE `empdepartment` (
  ...
  `EmpDepart` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`EmpNo`)
...
LOCK TABLES `empdepartment` WRITE;
/*!40000 ALTER TABLE `empdepartment` DISABLE KEYS */;
INSERT INTO `empdepartment` VALUES (101,'computer'),(102,'computer'),(103,'civil'),(104,'ETC'),(105,'Electrical'),(106,'IT'),(107,'Transport'),(108,'IT');
...
INSERT INTO `employee` VALUES (101,'Rajesh','Pune',15000,'2022-10-10'),(102,'Vedant','Mumbai',25000,'2022-10-10'),(103,'Swati','Mumbai',15000,'2022-10-10'),(104,'Smar','Nagpur',28000,'2022-10-10'),(105,'Swaraj','Virar',16000,'2022-10-10'),(106,'Nitkarsh','Virar',70000,'2022-10-10'),(107,'Pallavi','Virar',45000,'2022-10-10'),(108,'Purshotam','Bhinmal',90000,'2022-10-10');
...
-- Dump completed on 2022-10-10 23:48:58
